...
interface SearchHeaderProps {
    ...
    placeholder?: string;
    showAdvanced?: boolean;          // kept for compatibility but ignored if hideToggle true
    onToggleAdvanced?: () => void;   // kept for compatibility
    hideToggle?: boolean;            // new prop to hide the toggle button
    className?: string;
}
